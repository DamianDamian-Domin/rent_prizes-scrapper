...
class PoznanSpider(scrapy.Spider):
    ...
    def __init__(self):
        ...
        self.rooms = 0
        self.urls = [
            'https://www.olx.pl/d/nieruchomosci/mieszkania/wynajem/poznan/?search%5Bfilter_enum_rooms%5D%5B0%5D=two',
            'https://www.olx.pl/d/nieruchomosci/mieszkania/wynajem/poznan/?search%5Bfilter_enum_rooms%5D%5B0%5D=three',
            'https://www.olx.pl/d/nieruchomosci/mieszkania/wynajem/poznan/?search%5Bfilter_enum_rooms%5D%5B0%5D=four'
            ]

    name = 'poznan'
    start_urls = [
        'https://www.olx.pl/d/nieruchomosci/mieszkania/wynajem/poznan/?search%5Bfilter_enum_rooms%5D%5B0%5D=one',
    ]
